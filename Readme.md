...
* Студент: [Сергей Филоненко](https://up.htmlacademy.ru/adaptive/18/user/1164987).
* Наставник: [Максим Прусаков](https://htmlacademy.ru/profile/hikikomori).
<!-- Забыл добавить ветку, исправил :) -->
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/1164987-cat-energy-18) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
...
[travis-image]: https://travis-ci.com/htmlacademy-adaptive/1164987-cat-energy-18.svg?branch=master
